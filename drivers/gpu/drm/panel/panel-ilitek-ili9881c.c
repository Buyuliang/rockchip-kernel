...
static inline unsigned int ili9881c_delay_ms(u16 delay, unsigned int fallback)
{
	return delay ? delay : fallback;
}
...
static const struct ili9881c_instr umo_9522md_t_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(3),
	ILI9881C_COMMAND_INSTR(0x01, 0x00),
	ILI9881C_COMMAND_INSTR(0x02, 0x00),
	...
	ILI9881C_SWITCH_PAGE_INSTR(4),
	ILI9881C_COMMAND_INSTR(0x6E, 0x2A), /* di_pwr_reg=0 for power mode 2A, VGH clamp 18V */
	ILI9881C_COMMAND_INSTR(0x6F, 0x35), /* pumping ratio VGH=5x VGL=-3x */
	ILI9881C_COMMAND_INSTR(0x3A, 0x24), /* POWER SAVING */
	...
	ILI9881C_COMMAND_INSTR(0x63, 0x00),
	ILI9881C_COMMAND_INSTR(0xA0, 0x00),
	ILI9881C_COMMAND_INSTR(0xA1, 0x16), /* VP251 */
	ILI9881C_COMMAND_INSTR(0xA2, 0x26), /* VP247 */
	ILI9881C_COMMAND_INSTR(0xA3, 0x16), /* VP243 */
	ILI9881C_COMMAND_INSTR(0xA4, 0x19), /* VP239 */
	ILI9881C_COMMAND_INSTR(0xA5, 0x2b), /* VP231 */
	ILI9881C_COMMAND_INSTR(0xA6, 0x1E), /* VP219 */
	ILI9881C_COMMAND_INSTR(0xA7, 0x20), /* VP203 */
	ILI9881C_COMMAND_INSTR(0xA8, 0x93), /* VP175 */
	ILI9881C_COMMAND_INSTR(0xA9, 0x20), /* VP144 */
	ILI9881C_COMMAND_INSTR(0xAA, 0x2c), /* VP111 */
	ILI9881C_COMMAND_INSTR(0xAB, 0x87), /* VP80 */
	ILI9881C_COMMAND_INSTR(0xAC, 0x1f), /* VP52 */
	ILI9881C_COMMAND_INSTR(0xAD, 0x1f), /* VP36 */
	ILI9881C_COMMAND_INSTR(0xAE, 0x53), /* VP24 */
	ILI9881C_COMMAND_INSTR(0xAF, 0x27), /* VP16 */
	ILI9881C_COMMAND_INSTR(0xB0, 0x2a), /* VP12 */
	ILI9881C_COMMAND_INSTR(0xB1, 0x52), /* VP8 */
	ILI9881C_COMMAND_INSTR(0xB2, 0x5b), /* VP4 */
	ILI9881C_COMMAND_INSTR(0xB3, 0x23), /* VP0 */
	ILI9881C_COMMAND_INSTR(0xC0, 0x00), /* VN255 GAMMA N */
	ILI9881C_COMMAND_INSTR(0xC1, 0x11), /* VN251 */
	ILI9881C_COMMAND_INSTR(0xC2, 0x1e), /* VN247 */
	ILI9881C_COMMAND_INSTR(0xC3, 0x0f), /* VN243 */
	ILI9881C_COMMAND_INSTR(0xC4, 0x12), /* VN239 */
	ILI9881C_COMMAND_INSTR(0xC5, 0x26), /* VN231 */
	ILI9881C_COMMAND_INSTR(0xC6, 0x1c), /* VN219 */
	ILI9881C_COMMAND_INSTR(0xC7, 0x1e), /* VN203 */
	ILI9881C_COMMAND_INSTR(0xC8, 0x87), /* VN175 */
	ILI9881C_COMMAND_INSTR(0xC9, 0x19), /* VN144 */
	ILI9881C_COMMAND_INSTR(0xCA, 0x26), /* VN111 */
	ILI9881C_COMMAND_INSTR(0xCB, 0x7f), /* VN80 */
	ILI9881C_COMMAND_INSTR(0xCC, 0x20), /* VN52 */
	ILI9881C_COMMAND_INSTR(0xCD, 0x22), /* VN36 */
	ILI9881C_COMMAND_INSTR(0xCE, 0x58), /* VN24 */
	ILI9881C_COMMAND_INSTR(0xCF, 0x2a), /* VN16 */
	ILI9881C_COMMAND_INSTR(0xD0, 0x2e), /* VN12 */
	ILI9881C_COMMAND_INSTR(0xD1, 0x50), /* VN8 */
	ILI9881C_COMMAND_INSTR(0xD2, 0x5D), /* VN4 */
...
static int ili9881c_prepare(struct drm_panel *panel)
{
	...
	if (ret)
		return ret;
	msleep(ili9881c_delay_ms(ctx->desc->power_on_delay_ms, 5));

	/* And reset it */
	gpiod_set_value_cansleep(ctx->reset, 1);
	msleep(ili9881c_delay_ms(ctx->desc->reset_delay_ms, 20));

	gpiod_set_value_cansleep(ctx->reset, 0);
	msleep(ili9881c_delay_ms(ctx->desc->init_delay_ms, 20));
...
static int ili9881c_enable(struct drm_panel *panel)
{
	...
	msleep(ili9881c_delay_ms(ctx->desc->sleep_exit_delay_ms, 120));
...
static const struct drm_display_mode umo_9522md_t_default_mode = {
	.clock		= 73000,
...
static const struct ili9881c_desc umo_9522md_t_desc = {
	.init = umo_9522md_t_init,
	.init_length = ARRAY_SIZE(umo_9522md_t_init),
	.mode = &umo_9522md_t_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST,
	.power_on_delay_ms = 20,
	.reset_delay_ms = 20,
	.init_delay_ms = 120,
	.sleep_exit_delay_ms = 120,
};
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "urt,umo-9522md-t", .data = &umo_9522md_t_desc },
	{ }
};
